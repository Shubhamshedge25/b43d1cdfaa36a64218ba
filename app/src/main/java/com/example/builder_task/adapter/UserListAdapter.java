package com.example.builder_task.adapter;
...
import com.example.builder_task.R;
...
private ArrayList<UserListModel> userModalArrayList;
private Context context;

// creating a constructor.
public UserListAdapter(ArrayList<UserListModel> userModalArrayList, Context context) {
...
public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        UserListModel userModal = userModalArrayList.get(position);
...
public int getItemCount() {
    ...
    public void updateList(ArrayList<UserListModel> updateList){
        userModalArrayList = updateList;
